...
export const displayResponses = (sessionResults) => {
  ...
  responseContainerGrid.style["grid-template-columns"] = `repeat(${length}, auto)`;
  ...
  let ro = new ResizeObserver((entries) => {
    ...
    let responseGridWidth = document.querySelector('.result-grid-container').clientWidth
    ...
    if (mainGridDiff < 147) {
      ...
      let resultGridContainer = document.querySelector('.result-grid-container')
